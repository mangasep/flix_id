...
class TopUp implements UseCase<Result<void>, TopUpParam> {
  ...
  Future<Result<void>> call(TopUpParam params) async {
    ...
    var createTransactionResult = await createTransaction(CreateTransactionParam(transaction: Transaction(id: 'flxtp-$transactionTime-${params.userId}', uid: params.userId, title: 'Top UP', adminFee: 0, total: -params.amount, transactionTime: transactionTime,)));
